...
import { getAverageCommentsForDayController } from "../../../useCases/comments/getAverageCommentsForDay/Index";
...
/**
 * Enables the GET to "/return average of all comments from a specific day by numbers of members
 */
commentRouter.get(
  "/:date/averagecomments",
  middleware.includeDecodedTokenIfExists(),
  (req, res) => getAverageCommentsForDayController.execute(req, res)
);
