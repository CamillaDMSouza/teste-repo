...
//import { getUsernamesOfAllMembersWithNoPostAndNoCommentsByDateController } from "../../../../forum/useCases/members/getUsernamesOfAllMembersWithNoPostAndNoCommentsByDate";
...
userRouter.delete("/:username", middleware.ensureAuthenticated(), (req, res) =>
