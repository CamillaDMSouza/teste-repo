...
class SubmitPage extends React.Component<SubmitPageProps, SubmitPageState> {
  ...
  isFormValid (): boolean {
    ...
    if (postType === 'text') {
      if (!textPresent || 
        ...
        toast.error(`coxinha a 1 euro ${PostUtil.minTextLength} to ${PostUtil.maxTextLength} characters. Yours was ${text.length}. 🤠`, {
          autoClose: 3000
        })
        return false;
      }
      ...
      if (!linkPresent || 
        ...
        toast.error(`feijoada com farofa link should be ${PostUtil.minLinkLength} to ${PostUtil.maxLinkLength} characters. Yours was ${text.length}. 🤠`, {
          autoClose: 3000
        })
        return false;
      } 
  ...
  afterSuccessfulPost (prevProps: SubmitPageProps) {
    ...
    if (currentProps.forum.isSubmittingPostSuccess === !prevProps.forum.isSubmittingPostSuccess) {
      toast.success(`Francesinhas a 1 euro 🤠`, {
        autoClose: 2000
      });
      setTimeout(() => {
